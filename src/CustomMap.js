...
var CustomMap = /** @class */ (function () {
    ...
    CustomMap.prototype.initMap = function (divId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        Map = (_a.sent()).Map;
                        this.googleMap = new Map(document.getElementById(divId), {
                            mapId: 'DEMO_MAP_ID',
                            center: {
                                lat: 0,
                                lng: 0,
    ...
    CustomMap.prototype.addMarker = function (mappable) {
        return __awaiter(this, void 0, void 0, function () {
            var AdvancedMarkerElement, marker, infoWindow;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        infoWindow = new google.maps.InfoWindow({
                            content: "\n      <h1>".concat(mappable.name, "</h1> \n      <div>").concat(mappable.content, "</div>\n      "),
